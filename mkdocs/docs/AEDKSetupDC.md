...
<pre><code>SDK_DIR=~ \
SDK_VER=1.7.1.12 \
$(ck find ck-qaic:script:setup.aedk)/install_platform_sdk.sh</code></pre>
</details>
...
??? example "If you don't wish to use Docker images"
